...
////		Post post = new Post(new Writer(loginUser.getUserId(), loginUser.getName()), mp.readNextPart().("title"),
////				mp.getParameter("genre"), mp.getParameter("country"), mp.getParameter("instrument"));
//
//		PostContent postContent = null;
//		if (!imageNames.isEmpty()) {
//
//			postContent = new PostContent(req.getParameter("content"), req.getParameter("video_link"), imageNames);
//		} else {
//
//			postContent = new PostContent(req.getParameter("content"), req.getParameter("video_link"));
//		}
