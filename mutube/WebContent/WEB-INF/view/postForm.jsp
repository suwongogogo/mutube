...
<head>
    <meta charset="utf-8" />
    <title>글쓰기</title>
    <link rel="stylesheet" type="text/css" media="screen" href="/mutube/CSS/postForm.css" />
            ...
            <form action="write" method="post">
                ...
                <div class="select-container">
                    ...
                    <div class="musician-form">
                        <p class="title">뮤지션</p>
                        <select class="select">
                            <option value="#" selected class="option">뮤지션</option>
                        </select>
                    </div>
                    <div class="musician-form">
                        <p class="title">악기</p>
                ...
                <div class="video-container">
                    ...
                    <input type="text" class="video-input">
                </div>
                <div class="content">
