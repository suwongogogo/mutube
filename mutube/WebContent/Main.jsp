            ...
            <div class="nav">
                ...
                <div class="genre-container">
                    <ul class="genre-ul">
                        ...
                        <!-- dropdown -->
                        <li class="genre-li">
                            <span>Â·</span> <span onclick="view1()">장르</span>
                        ...
                        <li class="genre-li">
                            <span>Â·</span> <span onclick="view2()">ìê¸°</span>
                        ...
                        <li class="genre-li">
                            <span>Â·</span> <span onclick="view3()">ë®¤ì§ì</span>
...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
    ...
    <footer class="footer">
        <div class="footer-container">
            <p class="footer-text">A Person Who Made Project</p>
            <p class="person">ë°ì§êµ­, ì´ìì, ê¹ì¹ì©, ê¹ìì§</p>
            <p class="phone">ë¶ë§ìë ìë¼ ì í ê±¸ì´ë¼ 010-5543-1787</p>
        </div>
    </footer>
</body>
</html>